...
<el-dialog
          ...
          <div v-if="isShow">
            <el-form :inline="true" size="small" id="search">
              <el-form-item label="复查邀约结果：">
                <el-radio-group v-model="backInviteResult" @change="backInviteResult_func(backInviteResult)">
    ...
    <el-dialog
      title="客户流失登记"
      :visible.sync="new_details_data.yqwd_khls_dialog"
      width="30%"
    ...
    <el-dialog
      title="客户态度分析"
      :visible.sync="new_details_data.td_yqwddialog"
      width="30%"
...
export default {
  ...
  methods: {
    ...
    td_cancel() {
      this.new_details_data.td_yqwddialog = false;
      this.new_details_data.value = 0;
      this.new_details_data.causeOfLoss = null;
    },
    td_addVisit() {
      this.new_details_data.td_yqwddialog = true;
    },
    ls_cancel() {
      this.new_details_data.yqwd_khls_dialog = false;
      this.new_details_data.churnRegistration = null;
    },
     ls_save() {
      this.new_details_data.yqwd_khls_dialog = true;
    },
    seveTime() {
      ...
      selectUpdateBackWaitVisitDetail(data)
        .then(res => {
          ...
          if (res.data.returnCode != 0) {
            ...
            this.new_details_data.value = details.backVisitDetailDTO.memberAttitude;
            this.new_details_data.causeOfLoss = details.backVisitDetailDTO.memberAttitudeRemark;
